...
const (
	...
	ZDeviceState_ZDEVICE_STATE_CONVERTING ZDeviceState = 9
)
...
type ZDeviceSubState int32

const (
	ZDeviceSubState_ZDEVICE_SUBSTATE_UNSPECIFIED ZDeviceSubState = 0
	...
	ZDeviceSubState_ZDEVICE_SUBSTATE_CONVERT_REBOOTING_TO_RESIZE ZDeviceSubState = 1
	// Installing the EVE-k (or EVE-kvm) base image into the resized partitions.
	ZDeviceSubState_ZDEVICE_SUBSTATE_CONVERT_INSTALLING ZDeviceSubState = 2
	// Rebooting into the converted EVE flavor.
	ZDeviceSubState_ZDEVICE_SUBSTATE_CONVERT_REBOOTING_TO_TARGET ZDeviceSubState = 3
)

// Enum value maps for ZDeviceSubState.
var (
	ZDeviceSubState_name = map[int32]string{
		0: "ZDEVICE_SUBSTATE_UNSPECIFIED",
		1: "ZDEVICE_SUBSTATE_CONVERT_REBOOTING_TO_RESIZE",
		2: "ZDEVICE_SUBSTATE_CONVERT_INSTALLING",
		3: "ZDEVICE_SUBSTATE_CONVERT_REBOOTING_TO_TARGET",
	}
	ZDeviceSubState_value = map[string]int32{
...
func (x ZDeviceSubState) Enum() *ZDeviceSubState {
	p := new(ZDeviceSubState)
	*p = x
	return p
}

func (x ZDeviceSubState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ZDeviceSubState) Descriptor() protoreflect.EnumDescriptor {
	return file_info_info_proto_enumTypes[10].Descriptor()
}

func (ZDeviceSubState) Type() protoreflect.EnumType {
	return &file_info_info_proto_enumTypes[10]
}

func (x ZDeviceSubState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ZDeviceSubState.Descriptor instead.
func (ZDeviceSubState) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	APICapability_API_CAPABILITY_APP_INSTANCE_NET_INTERFACE_CHANGE APICapability = 22 // Support for adding and removing network interfaces without purge, but restart or the edge app
	APICapability_API_CAPABILITY_DEFERRED_QUEUE_METRICS            APICapability = 23 // Reports deviceMetric.deferred_queue and the per-URL retriable, rejected and delivered counts
)
...
var (
	APICapability_name = map[int32]string{
		...
		22: "API_CAPABILITY_APP_INSTANCE_NET_INTERFACE_CHANGE",
		23: "API_CAPABILITY_DEFERRED_QUEUE_METRICS",
	}
	APICapability_value = map[string]int32{
		...
		"API_CAPABILITY_DEFERRED_QUEUE_METRICS":            23,
	}
)
...
const (
	...
	BootReason_BOOT_REASON_KUBE_TRANSITION BootReason = 15 // Transition to/from kubernetes single/cluster modes
	...
	BootReason_BOOT_REASON_HW_WATCHDOG BootReason = 16
...
var (
	BootReason_name = map[int32]string{
		...
		15:  "BOOT_REASON_KUBE_TRANSITION",
		16:  "BOOT_REASON_HW_WATCHDOG",
	...
	BootReason_value = map[string]int32{
		...
		"BOOT_REASON_KUBE_TRANSITION": 15,
...
type ZInfoDevice struct {
	...
	SubState ZDeviceSubState `protobuf:"varint,61,opt,name=sub_state,json=subState,proto3,enum=org.lfedge.eve.info.ZDeviceSubState" json:"sub_state,omitempty"`
...
func (x *ZInfoDevice) GetSubState() ZDeviceSubState {
	if x != nil {
		return x.SubState
	}
	return ZDeviceSubState_ZDEVICE_SUBSTATE_UNSPECIFIED
}
...
func (x *OptionalCapabilities) GetEtcdSnapshot() bool {
	if x != nil {
		return x.EtcdSnapshot
	}
	return false
}
...
type DevicePort struct {
	...
	BondStatus *BondStatus `protobuf:"bytes,60,opt,name=bond_status,json=bondStatus,proto3" json:"bond_status,omitempty"`
}
...
func (x *DevicePort) GetBondStatus() *BondStatus {
	if x != nil {
		return x.BondStatus
	}
	return nil
...
type ZInfoStorage struct {
	...
	// empty).
	PartitionLabel string `protobuf:"bytes,5,opt,name=partitionLabel,proto3" json:"partitionLabel,omitempty"`
	...
	PartitionTypeGuid string `protobuf:"bytes,6,opt,name=partitionTypeGuid,proto3" json:"partitionTypeGuid,omitempty"`
	...
	PartitionUuid string `protobuf:"bytes,7,opt,name=partitionUuid,proto3" json:"partitionUuid,omitempty"`
}
...
func (x *ZInfoStorage) GetPartitionLabel() string {
	if x != nil {
		return x.PartitionLabel
	}
	return ""
...
func (x *ZInfoStorage) GetPartitionTypeGuid() string {
	if x != nil {
		return x.PartitionTypeGuid
	}
	return ""
}

func (x *ZInfoStorage) GetPartitionUuid() string {
	if x != nil {
...
type ZInfoKubeCluster struct {
	...
	Witness *KubeWitnessInfo `protobuf:"bytes,7,opt,name=witness,proto3" json:"witness,omitempty"`
}
...
func (x *ZInfoKubeCluster) GetWitness() *KubeWitnessInfo {
	if x != nil {
		return x.Witness
	}
	return nil
...
var file_info_info_proto_rawDesc = []byte{
	...
	0x0f, 0x69, 0x6e, 0x66, 0x6f, 0x2f, 0x62, 0x6f, 0x6e, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x1a, 0x0f, 0x69, 0x6e, 0x66, 0x6f, 0x2f, 0x70, 0x6e, 0x61, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x1a, 0x0f, 0x69, 0x6e, 0x66, 0x6f, 0x2f, 0x63, 0x65, 0x72, 0x74, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x1a, 0x11, 0x69, 0x6e, 0x66, 0x6f, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd8, 0x01, 0x0a, 0x09, 0x53, 0x6d, 0x61, 0x72, 0x74, 0x41,
	...
	,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x44, 0x22, 0xf2, 0x02, 0x0a,
	...
	0x42, 0x79, 0x42, 0x61, 0x73, 0x65, 0x4f, 0x53, 0x12, 0x46, 0x0a, 0x0d, 0x69, 0x6f, 0x41, 0x64,
	...
	0x2e, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x49, 0x6f, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65,
	0x73, 0x52, 0x0d, 0x69, 0x6f, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x4c, 0x69, 0x73, 0x74,
	0x12, 0x3d, 0x0a, 0x05, 0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x30, 0x0a, 0x03, 0x65, 0x72, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6f,
	0x72, 0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x2e, 0x69, 0x6e,
	0x66, 0x6f, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x03, 0x65, 0x72,
	0x72, 0x22, 0x6c, 0x0a, 0x0b, 0x49, 0x6f, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x2e, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x53, 0x74,
	...
	0x74, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x6d, 0x61, 0x72, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x6d, 0x61, 0x72, 0x74, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x93, 0x02, 0x0a, 0x0f, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	...
	0x4d, 0x73, 0x67, 0x22, 0xa3, 0x18, 0x0a, 0x0b, 0x5a, 0x49, 0x6e, 0x66, 0x6f, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x41, 0x72,
	0x63, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e,
	0x65, 0x41, 0x72, 0x63, 0x68, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x70, 0x75, 0x41, 0x72, 0x63, 0x68,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x70, 0x75, 0x41, 0x72, 0x63, 0x68, 0x12,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x48, 0x6f, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x4b, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x64, 0x12, 0x35, 0x0a, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x22, 0x0a, 0x0c, 0x73, 0x68,
	0x6f, 0x72, 0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0c, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x20,
	0x0a, 0x0b, 0x6c, 0x6f, 0x6e, 0x67, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0b, 0x6c, 0x6f, 0x6e, 0x67, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x12, 0x34, 0x0a, 0x05, 0x73, 0x77, 0x45, 0x72, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	,
	...
	0x52, 0x08, 0x62, 0x6f, 0x6f, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x4a, 0x0a, 0x10, 0x61, 0x73,
	...
	,
	...
	0x12, 0x40, 0x0a, 0x09, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x73, 0x18, 0x12, 0x20,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x70, 0x6f, 0x72, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x5f,
	0x61, 0x70, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x67, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x41, 0x70, 0x70, 0x22, 0xb7, 0x01, 0x0a, 0x09, 0x55, 0x73, 0x61, 0x67, 0x65, 0x49,
	...
	0x6c, 0x6f, 0x62, 0x52, 0x04, 0x62, 0x6c, 0x6f, 0x62, 0x22, 0xa7, 0x09, 0x0a, 0x08, 0x5a, 0x49,
	...
	,
	...
	0x70, 0x69, 0x72, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x3d, 0x0a, 0x0c, 0x73, 0x74, 0x61, 0x72,
	...
	0x74, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x5f, 0x64, 0x65, 0x76, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x44, 0x65, 0x76, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x61, 0x70,
	0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x41, 0x70,
	0x70, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x65, 0x78, 0x74, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x45, 0x78, 0x74, 0x22, 0xe8,
	0x03, 0x0a, 0x0d, 0x5a, 0x49, 0x6e, 0x66, 0x6f, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x5a, 0x46, 0x53, 0x10, 0x02, 0x2a, 0xb2, 0x07, 0x0a, 0x0d, 0x41, 0x50, 0x49, 0x43, 0x61, 0x70,
	...
	,
	...
	,
...
var file_info_info_proto_enumTypes = make([]protoimpl.EnumInfo, 27)
...
var file_info_info_proto_goTypes = []interface{}{
	...
	(ZDeviceSubState)(0),                 // 10: org.lfedge.eve.info.ZDeviceSubState
	...
	(ZInfoClusterNodeStatus)(0),          // 23: org.lfedge.eve.info.ZInfoClusterNodeStatus
	(ZInfoVpnState)(0),                   // 24: org.lfedge.eve.info.ZInfoVpnState
	(ZNetworkInstanceState)(0),           // 25: org.lfedge.eve.info.ZNetworkInstanceState
	(LocReliability)(0),                  // 26: org.lfedge.eve.info.LocReliability
	(*SmartAttr)(nil),                    // 27: org.lfedge.eve.info.SmartAttr
	(*StorageDiskInfo)(nil),              // 28: org.lfedge.eve.info.StorageDiskInfo
	(*DeprecatedMetricItem)(nil),         // 29: org.lfedge.eve.info.deprecatedMetricItem
	(*ZmetIPAssignmentEntry)(nil),        // 30: org.lfedge.eve.info.ZmetIPAssignmentEntry
	(*ZmetVifInfo)(nil),                  // 31: org.lfedge.eve.info.ZmetVifInfo
	(*ZioBundle)(nil),                    // 32: org.lfedge.eve.info.ZioBundle
	(*IoAddresses)(nil),                  // 33: org.lfedge.eve.info.IoAddresses
	(*VfPublishedInfo)(nil),              // 34: org.lfedge.eve.info.VfPublishedInfo
	(*ZInfoManufacturer)(nil),            // 35: org.lfedge.eve.info.ZInfoManufacturer
	(*ZInfoNetwork)(nil),                 // 36: org.lfedge.eve.info.ZInfoNetwork
	(*GeoLoc)(nil),                       // 37: org.lfedge.eve.info.GeoLoc
	(*ZInfoDNS)(nil),                     // 38: org.lfedge.eve.info.ZInfoDNS
	(*ZInfoSW)(nil),                      // 39: org.lfedge.eve.info.ZInfoSW
	(*VaultInfo)(nil),                    // 40: org.lfedge.eve.info.VaultInfo
	(*DataSecAtRest)(nil),                // 41: org.lfedge.eve.info.DataSecAtRest
	(*SecurityInfo)(nil),                 // 42: org.lfedge.eve.info.SecurityInfo
	(*ZInfoConfigItem)(nil),              // 43: org.lfedge.eve.info.ZInfoConfigItem
	(*ZInfoConfigItemStatus)(nil),        // 44: org.lfedge.eve.info.ZInfoConfigItemStatus
	(*ZInfoAppInstance)(nil),             // 45: org.lfedge.eve.info.ZInfoAppInstance
	(*ZInfoDeviceTasks)(nil),             // 46: org.lfedge.eve.info.ZInfoDeviceTasks
	(*ZSimcardInfo)(nil),                 // 47: org.lfedge.eve.info.ZSimcardInfo
	(*ZCellularModuleInfo)(nil),          // 48: org.lfedge.eve.info.ZCellularModuleInfo
	(*ZCellularProvider)(nil),            // 49: org.lfedge.eve.info.ZCellularProvider
	(*CellularBearer)(nil),               // 50: org.lfedge.eve.info.CellularBearer
	(*CellularProfile)(nil),              // 51: org.lfedge.eve.info.CellularProfile
	(*StorageDiskState)(nil),             // 52: org.lfedge.eve.info.StorageDiskState
	(*StorageChildren)(nil),              // 53: org.lfedge.eve.info.StorageChildren
	(*StorageInfo)(nil),                  // 54: org.lfedge.eve.info.StorageInfo
	(*ZInfoDevice)(nil),                  // 55: org.lfedge.eve.info.ZInfoDevice
	(*OptionalCapabilities)(nil),         // 56: org.lfedge.eve.info.OptionalCapabilities
	...
	(*ZInfoClusterNode)(nil),             // 68: org.lfedge.eve.info.ZInfoClusterNode
	(*ZInfoApp)(nil),                     // 69: org.lfedge.eve.info.ZInfoApp
	(*ZInfoVpnLinkInfo)(nil),             // 70: org.lfedge.eve.info.ZInfoVpnLinkInfo
	(*ZInfoVpnLink)(nil),                 // 71: org.lfedge.eve.info.ZInfoVpnLink
	(*ZInfoVpnEndPoint)(nil),             // 72: org.lfedge.eve.info.ZInfoVpnEndPoint
	(*ZInfoVpnConn)(nil),                 // 73: org.lfedge.eve.info.ZInfoVpnConn
	(*ZInfoVpn)(nil),                     // 74: org.lfedge.eve.info.ZInfoVpn
	(*ZInfoNetworkInstance)(nil),         // 75: org.lfedge.eve.info.ZInfoNetworkInstance
	(*IPRoute)(nil),                      // 76: org.lfedge.eve.info.IPRoute
	(*UsageInfo)(nil),                    // 77: org.lfedge.eve.info.UsageInfo
	(*VolumeResources)(nil),              // 78: org.lfedge.eve.info.VolumeResources
	(*ZInfoVolume)(nil),                  // 79: org.lfedge.eve.info.ZInfoVolume
	(*ContentResources)(nil),             // 80: org.lfedge.eve.info.ContentResources
	(*ZInfoContentTree)(nil),             // 81: org.lfedge.eve.info.ZInfoContentTree
	(*ZInfoBlob)(nil),                    // 82: org.lfedge.eve.info.ZInfoBlob
	(*ZInfoBlobList)(nil),                // 83: org.lfedge.eve.info.ZInfoBlobList
	(*ZInfoMsg)(nil),                     // 84: org.lfedge.eve.info.ZInfoMsg
	(*Capabilities)(nil),                 // 85: org.lfedge.eve.info.Capabilities
	(*ZInfoAppInstMetaData)(nil),         // 86: org.lfedge.eve.info.ZInfoAppInstMetaData
	(*ZInfoEdgeview)(nil),                // 87: org.lfedge.eve.info.ZInfoEdgeview
	(*ZInfoLocation)(nil),                // 88: org.lfedge.eve.info.ZInfoLocation
	(*ZInfoKubeClusterUpdateStatus)(nil), // 89: org.lfedge.eve.info.ZInfoKubeClusterUpdateStatus
	(*ZInfoKubeCluster)(nil),             // 90: org.lfedge.eve.info.ZInfoKubeCluster
	(*ZInfoHardware)(nil),                // 91: org.lfedge.eve.info.ZInfoHardware
	...
	(*ErrorInfo)(nil),                    // 96: org.lfedge.eve.info.ErrorInfo
	(evecommon.BearerType)(0),            // 97: org.lfedge.eve.common.BearerType
	(evecommon.CellularIPType)(0),        // 98: org.lfedge.eve.common.CellularIPType
	(*timestamppb.Timestamp)(nil),        // 99: google.protobuf.Timestamp
	(*evecommon.DiskDescription)(nil),    // 100: org.lfedge.eve.common.DiskDescription
	(*CertInfo)(nil),                     // 101: org.lfedge.eve.info.CertInfo
	(*evecommon.PortConfigSource)(nil),   // 102: org.lfedge.eve.common.PortConfigSource
	(*PNACStatus)(nil),                   // 103: org.lfedge.eve.info.PNACStatus
	(*BondStatus)(nil),                   // 104: org.lfedge.eve.info.BondStatus
	(evecommon.RadioAccessTechnology)(0), // 105: org.lfedge.eve.common.RadioAccessTechnology
	(*ZInfoPatchEnvelope)(nil),           // 106: org.lfedge.eve.info.ZInfoPatchEnvelope
	(*ZInfoNTPSources)(nil),              // 107: org.lfedge.eve.info.ZInfoNTPSources
	(KubeComp)(0),                        // 108: org.lfedge.eve.info.KubeComp
	(KubeCompUpdateStatus)(0),            // 109: org.lfedge.eve.info.KubeCompUpdateStatus
	(*KubeNodeInfo)(nil),                 // 110: org.lfedge.eve.info.KubeNodeInfo
	(*KubePodNameSpaceInfo)(nil),         // 111: org.lfedge.eve.info.KubePodNameSpaceInfo
	(*KubeEVEAppPodInfo)(nil),            // 112: org.lfedge.eve.info.KubeEVEAppPodInfo
	(*KubeStorageInfo)(nil),              // 113: org.lfedge.eve.info.KubeStorageInfo
	(*KubeVMIInfo)(nil),                  // 114: org.lfedge.eve.info.KubeVMIInfo
	(*KubeWitnessInfo)(nil),              // 115: org.lfedge.eve.info.KubeWitnessInfo
	(*HardwareInventory)(nil),            // 116: org.lfedge.eve.info.HardwareInventory
}
var file_info_info_proto_depIdxs = []int32{
	27,  // 0: org.lfedge.eve.info.StorageDiskInfo.smart_attr:type_name -> org.lfedge.eve.info.SmartAttr
	0,   // 1: org.lfedge.eve.info.deprecatedMetricItem.type:type_name -> org.lfedge.eve.info.DepMetricItemType
	94,  // 2: org.lfedge.eve.info.ZioBundle.type:type_name -> org.lfedge.eve.common.PhyIoType
	33,  // 3: org.lfedge.eve.info.ZioBundle.ioAddressList:type_name -> org.lfedge.eve.info.IoAddresses
	95,  // 4: org.lfedge.eve.info.ZioBundle.usage:type_name -> org.lfedge.eve.common.PhyIoMemberUsage
	96,  // 5: org.lfedge.eve.info.ZioBundle.err:type_name -> org.lfedge.eve.info.ErrorInfo
	34,  // 6: org.lfedge.eve.info.IoAddresses.vf_info:type_name -> org.lfedge.eve.info.VfPublishedInfo
	38,  // 7: org.lfedge.eve.info.ZInfoNetwork.dns:type_name -> org.lfedge.eve.info.ZInfoDNS
	37,  // 8: org.lfedge.eve.info.ZInfoNetwork.location:type_name -> org.lfedge.eve.info.GeoLoc
	96,  // 9: org.lfedge.eve.info.ZInfoNetwork.networkErr:type_name -> org.lfedge.eve.info.ErrorInfo
	61,  // 10: org.lfedge.eve.info.ZInfoNetwork.proxy:type_name -> org.lfedge.eve.info.ProxyStatus
	...
	96,  // 13: org.lfedge.eve.info.VaultInfo.vaultErr:type_name -> org.lfedge.eve.info.ErrorInfo
	...
	40,  // 16: org.lfedge.eve.info.DataSecAtRest.vaultList:type_name -> org.lfedge.eve.info.VaultInfo
	92,  // 17: org.lfedge.eve.info.ZInfoConfigItemStatus.configItems:type_name -> org.lfedge.eve.info.ZInfoConfigItemStatus.ConfigItemsEntry
	93,  // 18: org.lfedge.eve.info.ZInfoConfigItemStatus.unknownConfigItems:type_name -> org.lfedge.eve.info.ZInfoConfigItemStatus.UnknownConfigItemsEntry
	...
	97,  // 22: org.lfedge.eve.info.CellularBearer.bearer_type:type_name -> org.lfedge.eve.common.BearerType
	98,  // 23: org.lfedge.eve.info.CellularBearer.ip_type:type_name -> org.lfedge.eve.common.CellularIPType
	99,  // 24: org.lfedge.eve.info.CellularBearer.connected_at:type_name -> google.protobuf.Timestamp
	97,  // 25: org.lfedge.eve.info.CellularProfile.bearer_type:type_name -> org.lfedge.eve.common.BearerType
	98,  // 26: org.lfedge.eve.info.CellularProfile.ip_type:type_name -> org.lfedge.eve.common.CellularIPType
	100, // 27: org.lfedge.eve.info.StorageDiskState.disk_name:type_name -> org.lfedge.eve.common.DiskDescription
	11,  // 28: org.lfedge.eve.info.StorageDiskState.status:type_name -> org.lfedge.eve.info.StorageStatus
	12,  // 29: org.lfedge.eve.info.StorageChildren.current_raid:type_name -> org.lfedge.eve.info.StorageRaidType
	52,  // 30: org.lfedge.eve.info.StorageChildren.disks:type_name -> org.lfedge.eve.info.StorageDiskState
	53,  // 31: org.lfedge.eve.info.StorageChildren.children:type_name -> org.lfedge.eve.info.StorageChildren
	13,  // 32: org.lfedge.eve.info.StorageInfo.storage_type:type_name -> org.lfedge.eve.info.StorageTypeInfo
	12,  // 33: org.lfedge.eve.info.StorageInfo.current_raid:type_name -> org.lfedge.eve.info.StorageRaidType
	11,  // 34: org.lfedge.eve.info.StorageInfo.storage_state:type_name -> org.lfedge.eve.info.StorageStatus
	52,  // 35: org.lfedge.eve.info.StorageInfo.disks:type_name -> org.lfedge.eve.info.StorageDiskState
	53,  // 36: org.lfedge.eve.info.StorageInfo.children:type_name -> org.lfedge.eve.info.StorageChildren
	35,  // 37: org.lfedge.eve.info.ZInfoDevice.minfo:type_name -> org.lfedge.eve.info.ZInfoManufacturer
	36,  // 38: org.lfedge.eve.info.ZInfoDevice.network:type_name -> org.lfedge.eve.info.ZInfoNetwork
	32,  // 39: org.lfedge.eve.info.ZInfoDevice.assignableAdapters:type_name -> org.lfedge.eve.info.ZioBundle
	38,  // 40: org.lfedge.eve.info.ZInfoDevice.dns:type_name -> org.lfedge.eve.info.ZInfoDNS
	66,  // 41: org.lfedge.eve.info.ZInfoDevice.storageList:type_name -> org.lfedge.eve.info.ZInfoStorage
	99,  // 42: org.lfedge.eve.info.ZInfoDevice.bootTime:type_name -> google.protobuf.Timestamp
	65,  // 43: org.lfedge.eve.info.ZInfoDevice.swList:type_name -> org.lfedge.eve.info.ZInfoDevSW
	29,  // 44: org.lfedge.eve.info.ZInfoDevice.metricItems:type_name -> org.lfedge.eve.info.deprecatedMetricItem
	99,  // 45: org.lfedge.eve.info.ZInfoDevice.lastRebootTime:type_name -> google.protobuf.Timestamp
	58,  // 46: org.lfedge.eve.info.ZInfoDevice.systemAdapter:type_name -> org.lfedge.eve.info.SystemAdapterInfo
	3,   // 47: org.lfedge.eve.info.ZInfoDevice.HSMStatus:type_name -> org.lfedge.eve.info.HwSecurityModuleStatus
	41,  // 48: org.lfedge.eve.info.ZInfoDevice.dataSecAtRestInfo:type_name -> org.lfedge.eve.info.DataSecAtRest
	42,  // 49: org.lfedge.eve.info.ZInfoDevice.sec_info:type_name -> org.lfedge.eve.info.SecurityInfo
	44,  // 50: org.lfedge.eve.info.ZInfoDevice.configItemStatus:type_name -> org.lfedge.eve.info.ZInfoConfigItemStatus
	45,  // 51: org.lfedge.eve.info.ZInfoDevice.appInstances:type_name -> org.lfedge.eve.info.ZInfoAppInstance
	15,  // 52: org.lfedge.eve.info.ZInfoDevice.last_boot_reason:type_name -> org.lfedge.eve.info.BootReason
	48,  // 53: org.lfedge.eve.info.ZInfoDevice.cell_radios:type_name -> org.lfedge.eve.info.ZCellularModuleInfo
	47,  // 54: org.lfedge.eve.info.ZInfoDevice.sims:type_name -> org.lfedge.eve.info.ZSimcardInfo
	46,  // 55: org.lfedge.eve.info.ZInfoDevice.tasks:type_name -> org.lfedge.eve.info.ZInfoDeviceTasks
	16,  // 56: org.lfedge.eve.info.ZInfoDevice.maintenance_mode_reason:type_name -> org.lfedge.eve.info.MaintenanceModeReason
	85,  // 57: org.lfedge.eve.info.ZInfoDevice.capabilities:type_name -> org.lfedge.eve.info.Capabilities
	9,   // 58: org.lfedge.eve.info.ZInfoDevice.state:type_name -> org.lfedge.eve.info.ZDeviceState
	10,  // 59: org.lfedge.eve.info.ZInfoDevice.sub_state:type_name -> org.lfedge.eve.info.ZDeviceSubState
	16,  // 60: org.lfedge.eve.info.ZInfoDevice.maintenance_mode_reasons:type_name -> org.lfedge.eve.info.MaintenanceModeReason
	54,  // 61: org.lfedge.eve.info.ZInfoDevice.storage_info:type_name -> org.lfedge.eve.info.StorageInfo
	57,  // 62: org.lfedge.eve.info.ZInfoDevice.attestation_info:type_name -> org.lfedge.eve.info.AttestationInfo
	14,  // 63: org.lfedge.eve.info.ZInfoDevice.api_capability:type_name -> org.lfedge.eve.info.APICapability
	56,  // 64: org.lfedge.eve.info.ZInfoDevice.optional_capabilities:type_name -> org.lfedge.eve.info.OptionalCapabilities
	101, // 65: org.lfedge.eve.info.ZInfoDevice.enrolled_certs:type_name -> org.lfedge.eve.info.CertInfo
	17,  // 66: org.lfedge.eve.info.AttestationInfo.state:type_name -> org.lfedge.eve.info.AttestationState
	96,  // 67: org.lfedge.eve.info.AttestationInfo.error:type_name -> org.lfedge.eve.info.ErrorInfo
	59,  // 68: org.lfedge.eve.info.SystemAdapterInfo.status:type_name -> org.lfedge.eve.info.DevicePortStatus
	99,  // 69: org.lfedge.eve.info.DevicePortStatus.timePriority:type_name -> google.protobuf.Timestamp
	99,  // 70: org.lfedge.eve.info.DevicePortStatus.lastFailed:type_name -> google.protobuf.Timestamp
	99,  // 71: org.lfedge.eve.info.DevicePortStatus.lastSucceeded:type_name -> google.protobuf.Timestamp
	60,  // 72: org.lfedge.eve.info.DevicePortStatus.ports:type_name -> org.lfedge.eve.info.DevicePort
	61,  // 73: org.lfedge.eve.info.DevicePort.proxy:type_name -> org.lfedge.eve.info.ProxyStatus
	38,  // 74: org.lfedge.eve.info.DevicePort.dns:type_name -> org.lfedge.eve.info.ZInfoDNS
	37,  // 75: org.lfedge.eve.info.DevicePort.location:type_name -> org.lfedge.eve.info.GeoLoc
	96,  // 76: org.lfedge.eve.info.DevicePort.err:type_name -> org.lfedge.eve.info.ErrorInfo
	95,  // 77: org.lfedge.eve.info.DevicePort.usage:type_name -> org.lfedge.eve.common.PhyIoMemberUsage
	63,  // 78: org.lfedge.eve.info.DevicePort.wireless_status:type_name -> org.lfedge.eve.info.WirelessStatus
	102, // 79: org.lfedge.eve.info.DevicePort.config_source:type_name -> org.lfedge.eve.common.PortConfigSource
	103, // 80: org.lfedge.eve.info.DevicePort.pnac_status:type_name -> org.lfedge.eve.info.PNACStatus
	104, // 81: org.lfedge.eve.info.DevicePort.bond_status:type_name -> org.lfedge.eve.info.BondStatus
	62,  // 82: org.lfedge.eve.info.ProxyStatus.proxies:type_name -> org.lfedge.eve.info.ProxyEntry
	19,  // 83: org.lfedge.eve.info.WirelessStatus.type:type_name -> org.lfedge.eve.info.WirelessType
	64,  // 84: org.lfedge.eve.info.WirelessStatus.cellular:type_name -> org.lfedge.eve.info.ZCellularStatus
	49,  // 85: org.lfedge.eve.info.ZCellularStatus.providers:type_name -> org.lfedge.eve.info.ZCellularProvider
	105, // 86: org.lfedge.eve.info.ZCellularStatus.current_rats:type_name -> org.lfedge.eve.common.RadioAccessTechnology
	99,  // 87: org.lfedge.eve.info.ZCellularStatus.connected_at:type_name -> google.protobuf.Timestamp
	50,  // 88: org.lfedge.eve.info.ZCellularStatus.bearers:type_name -> org.lfedge.eve.info.CellularBearer
	51,  // 89: org.lfedge.eve.info.ZCellularStatus.profiles:type_name -> org.lfedge.eve.info.CellularProfile
	2,   // 90: org.lfedge.eve.info.ZInfoDevSW.status:type_name -> org.lfedge.eve.info.ZSwState
	96,  // 91: org.lfedge.eve.info.ZInfoDevSW.swErr:type_name -> org.lfedge.eve.info.ErrorInfo
	20,  // 92: org.lfedge.eve.info.ZInfoDevSW.userStatus:type_name -> org.lfedge.eve.info.BaseOsStatus
	21,  // 93: org.lfedge.eve.info.ZInfoDevSW.subStatus:type_name -> org.lfedge.eve.info.BaseOsSubStatus
	99,  // 94: org.lfedge.eve.info.ZInfoSnapshot.create_time:type_name -> google.protobuf.Timestamp
	22,  // 95: org.lfedge.eve.info.ZInfoSnapshot.type:type_name -> org.lfedge.eve.info.SnapshotType
	96,  // 96: org.lfedge.eve.info.ZInfoSnapshot.snap_err:type_name -> org.lfedge.eve.info.ErrorInfo
	23,  // 97: org.lfedge.eve.info.ZInfoClusterNode.node_status:type_name -> org.lfedge.eve.info.ZInfoClusterNodeStatus
	39,  // 98: org.lfedge.eve.info.ZInfoApp.softwareList:type_name -> org.lfedge.eve.info.ZInfoSW
	99,  // 99: org.lfedge.eve.info.ZInfoApp.bootTime:type_name -> google.protobuf.Timestamp
	32,  // 100: org.lfedge.eve.info.ZInfoApp.assignedAdapters:type_name -> org.lfedge.eve.info.ZioBundle
	96,  // 101: org.lfedge.eve.info.ZInfoApp.appErr:type_name -> org.lfedge.eve.info.ErrorInfo
	2,   // 102: org.lfedge.eve.info.ZInfoApp.state:type_name -> org.lfedge.eve.info.ZSwState
	36,  // 103: org.lfedge.eve.info.ZInfoApp.network:type_name -> org.lfedge.eve.info.ZInfoNetwork
	67,  // 104: org.lfedge.eve.info.ZInfoApp.snapshots:type_name -> org.lfedge.eve.info.ZInfoSnapshot
	24,  // 105: org.lfedge.eve.info.ZInfoVpnLink.state:type_name -> org.lfedge.eve.info.ZInfoVpnState
	70,  // 106: org.lfedge.eve.info.ZInfoVpnLink.lInfo:type_name -> org.lfedge.eve.info.ZInfoVpnLinkInfo
	70,  // 107: org.lfedge.eve.info.ZInfoVpnLink.rInfo:type_name -> org.lfedge.eve.info.ZInfoVpnLinkInfo
	24,  // 108: org.lfedge.eve.info.ZInfoVpnConn.state:type_name -> org.lfedge.eve.info.ZInfoVpnState
	72,  // 109: org.lfedge.eve.info.ZInfoVpnConn.lInfo:type_name -> org.lfedge.eve.info.ZInfoVpnEndPoint
	72,  // 110: org.lfedge.eve.info.ZInfoVpnConn.rInfo:type_name -> org.lfedge.eve.info.ZInfoVpnEndPoint
	71,  // 111: org.lfedge.eve.info.ZInfoVpnConn.links:type_name -> org.lfedge.eve.info.ZInfoVpnLink
	73,  // 112: org.lfedge.eve.info.ZInfoVpn.conn:type_name -> org.lfedge.eve.info.ZInfoVpnConn
	99,  // 113: org.lfedge.eve.info.ZInfoNetworkInstance.upTimeStamp:type_name -> google.protobuf.Timestamp
	39,  // 114: org.lfedge.eve.info.ZInfoNetworkInstance.softwareList:type_name -> org.lfedge.eve.info.ZInfoSW
	30,  // 115: org.lfedge.eve.info.ZInfoNetworkInstance.ipAssignments:type_name -> org.lfedge.eve.info.ZmetIPAssignmentEntry
	31,  // 116: org.lfedge.eve.info.ZInfoNetworkInstance.vifs:type_name -> org.lfedge.eve.info.ZmetVifInfo
	32,  // 117: org.lfedge.eve.info.ZInfoNetworkInstance.assignedAdapters:type_name -> org.lfedge.eve.info.ZioBundle
	74,  // 118: org.lfedge.eve.info.ZInfoNetworkInstance.vinfo:type_name -> org.lfedge.eve.info.ZInfoVpn
	96,  // 119: org.lfedge.eve.info.ZInfoNetworkInstance.networkErr:type_name -> org.lfedge.eve.info.ErrorInfo
	25,  // 120: org.lfedge.eve.info.ZInfoNetworkInstance.state:type_name -> org.lfedge.eve.info.ZNetworkInstanceState
	76,  // 121: org.lfedge.eve.info.ZInfoNetworkInstance.ip_routes:type_name -> org.lfedge.eve.info.IPRoute
	99,  // 122: org.lfedge.eve.info.UsageInfo.createTime:type_name -> google.protobuf.Timestamp
	99,  // 123: org.lfedge.eve.info.UsageInfo.lastRefcountChangeTime:type_name -> google.protobuf.Timestamp
	77,  // 124: org.lfedge.eve.info.ZInfoVolume.usage:type_name -> org.lfedge.eve.info.UsageInfo
	78,  // 125: org.lfedge.eve.info.ZInfoVolume.resources:type_name -> org.lfedge.eve.info.VolumeResources
	2,   // 126: org.lfedge.eve.info.ZInfoVolume.state:type_name -> org.lfedge.eve.info.ZSwState
	96,  // 127: org.lfedge.eve.info.ZInfoVolume.volumeErr:type_name -> org.lfedge.eve.info.ErrorInfo
	80,  // 128: org.lfedge.eve.info.ZInfoContentTree.resources:type_name -> org.lfedge.eve.info.ContentResources
	77,  // 129: org.lfedge.eve.info.ZInfoContentTree.usage:type_name -> org.lfedge.eve.info.UsageInfo
	2,   // 130: org.lfedge.eve.info.ZInfoContentTree.state:type_name -> org.lfedge.eve.info.ZSwState
	96,  // 131: org.lfedge.eve.info.ZInfoContentTree.err:type_name -> org.lfedge.eve.info.ErrorInfo
	80,  // 132: org.lfedge.eve.info.ZInfoBlob.resources:type_name -> org.lfedge.eve.info.ContentResources
	77,  // 133: org.lfedge.eve.info.ZInfoBlob.usage:type_name -> org.lfedge.eve.info.UsageInfo
	2,   // 134: org.lfedge.eve.info.ZInfoBlob.state:type_name -> org.lfedge.eve.info.ZSwState
	96,  // 135: org.lfedge.eve.info.ZInfoBlob.err:type_name -> org.lfedge.eve.info.ErrorInfo
	82,  // 136: org.lfedge.eve.info.ZInfoBlobList.blob:type_name -> org.lfedge.eve.info.ZInfoBlob
	1,   // 137: org.lfedge.eve.info.ZInfoMsg.ztype:type_name -> org.lfedge.eve.info.ZInfoTypes
	55,  // 138: org.lfedge.eve.info.ZInfoMsg.dinfo:type_name -> org.lfedge.eve.info.ZInfoDevice
	69,  // 139: org.lfedge.eve.info.ZInfoMsg.ainfo:type_name -> org.lfedge.eve.info.ZInfoApp
	75,  // 140: org.lfedge.eve.info.ZInfoMsg.niinfo:type_name -> org.lfedge.eve.info.ZInfoNetworkInstance
	79,  // 141: org.lfedge.eve.info.ZInfoMsg.vinfo:type_name -> org.lfedge.eve.info.ZInfoVolume
	81,  // 142: org.lfedge.eve.info.ZInfoMsg.cinfo:type_name -> org.lfedge.eve.info.ZInfoContentTree
	83,  // 143: org.lfedge.eve.info.ZInfoMsg.binfo:type_name -> org.lfedge.eve.info.ZInfoBlobList
	86,  // 144: org.lfedge.eve.info.ZInfoMsg.amdinfo:type_name -> org.lfedge.eve.info.ZInfoAppInstMetaData
	87,  // 145: org.lfedge.eve.info.ZInfoMsg.evinfo:type_name -> org.lfedge.eve.info.ZInfoEdgeview
	91,  // 146: org.lfedge.eve.info.ZInfoMsg.hwinfo:type_name -> org.lfedge.eve.info.ZInfoHardware
	88,  // 147: org.lfedge.eve.info.ZInfoMsg.locinfo:type_name -> org.lfedge.eve.info.ZInfoLocation
	106, // 148: org.lfedge.eve.info.ZInfoMsg.patchInfo:type_name -> org.lfedge.eve.info.ZInfoPatchEnvelope
	68,  // 149: org.lfedge.eve.info.ZInfoMsg.cluster_node:type_name -> org.lfedge.eve.info.ZInfoClusterNode
	107, // 150: org.lfedge.eve.info.ZInfoMsg.ntp_sources:type_name -> org.lfedge.eve.info.ZInfoNTPSources
	90,  // 151: org.lfedge.eve.info.ZInfoMsg.cluster_info:type_name -> org.lfedge.eve.info.ZInfoKubeCluster
	89,  // 152: org.lfedge.eve.info.ZInfoMsg.cluster_update_info:type_name -> org.lfedge.eve.info.ZInfoKubeClusterUpdateStatus
	99,  // 153: org.lfedge.eve.info.ZInfoMsg.atTimeStamp:type_name -> google.protobuf.Timestamp
	18,  // 154: org.lfedge.eve.info.ZInfoAppInstMetaData.type:type_name -> org.lfedge.eve.info.AppInstMetaDataType
	99,  // 155: org.lfedge.eve.info.ZInfoEdgeview.expire_time:type_name -> google.protobuf.Timestamp
	99,  // 156: org.lfedge.eve.info.ZInfoEdgeview.started_time:type_name -> google.protobuf.Timestamp
	99,  // 157: org.lfedge.eve.info.ZInfoLocation.utc_timestamp:type_name -> google.protobuf.Timestamp
	26,  // 158: org.lfedge.eve.info.ZInfoLocation.horizontal_reliability:type_name -> org.lfedge.eve.info.LocReliability
	26,  // 159: org.lfedge.eve.info.ZInfoLocation.vertical_reliability:type_name -> org.lfedge.eve.info.LocReliability
	108, // 160: org.lfedge.eve.info.ZInfoKubeClusterUpdateStatus.component:type_name -> org.lfedge.eve.info.KubeComp
	109, // 161: org.lfedge.eve.info.ZInfoKubeClusterUpdateStatus.status:type_name -> org.lfedge.eve.info.KubeCompUpdateStatus
	96,  // 162: org.lfedge.eve.info.ZInfoKubeClusterUpdateStatus.error:type_name -> org.lfedge.eve.info.ErrorInfo
	110, // 163: org.lfedge.eve.info.ZInfoKubeCluster.nodes:type_name -> org.lfedge.eve.info.KubeNodeInfo
	111, // 164: org.lfedge.eve.info.ZInfoKubeCluster.pod_name_spaces:type_name -> org.lfedge.eve.info.KubePodNameSpaceInfo
	112, // 165: org.lfedge.eve.info.ZInfoKubeCluster.eve_apps:type_name -> org.lfedge.eve.info.KubeEVEAppPodInfo
	113, // 166: org.lfedge.eve.info.ZInfoKubeCluster.storage:type_name -> org.lfedge.eve.info.KubeStorageInfo
	114, // 167: org.lfedge.eve.info.ZInfoKubeCluster.eve_vm_apps:type_name -> org.lfedge.eve.info.KubeVMIInfo
	115, // 168: org.lfedge.eve.info.ZInfoKubeCluster.witness:type_name -> org.lfedge.eve.info.KubeWitnessInfo
	28,  // 169: org.lfedge.eve.info.ZInfoHardware.disks:type_name -> org.lfedge.eve.info.StorageDiskInfo
	116, // 170: org.lfedge.eve.info.ZInfoHardware.inventory:type_name -> org.lfedge.eve.info.HardwareInventory
	43,  // 171: org.lfedge.eve.info.ZInfoConfigItemStatus.ConfigItemsEntry.value:type_name -> org.lfedge.eve.info.ZInfoConfigItem
	43,  // 172: org.lfedge.eve.info.ZInfoConfigItemStatus.UnknownConfigItemsEntry.value:type_name -> org.lfedge.eve.info.ZInfoConfigItem
