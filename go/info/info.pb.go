...
const (
	...
	ZInfoTypes_ZiKubeCluster             ZInfoTypes = 17
	ZInfoTypes_ZiKubeClusterUpdateStatus ZInfoTypes = 18
)
...
var (
	APICapability_name = map[int32]string{
		...
		10: "API_CAPABILITY_ENFORCED_NET_INTERFACE_ORDER",
		11: "API_CAPABILITY_NTPS_FQDN",
		12: "API_CAPABILITY_WIN_LIC_PASSTHROUGH",
		13: "API_CAPABILITY_VOLUME_SNAPSHOTS_IMMEDIATE",
		14: "API_CAPABILITY_ENCRYPTED_PATCH_ENVELOPE",
		15: "API_CAPABILITY_SINGLE_STACK_IP_NETWORK",
		16: "API_CAPABILITY_CELLULAR_ATTACH_CONFIG",
		17: "API_CAPABILITY_EDGEVIEW_AUTHENTICATION",
		18: "API_CAPABILITY_DISABLE_VTPM",
		19: "API_CAPABILITY_LOC_REBOOT_COLLECT_INFO",
		20: "API_CAPABILITY_SMART_REPORT",
		21: "API_CAPABILITY_REPORT_TPM_EVENTLOG",
	}
	APICapability_value = map[string]int32{
		...
		"API_CAPABILITY_ENFORCED_NET_INTERFACE_ORDER": 10,
		"API_CAPABILITY_NTPS_FQDN":                    11,
		"API_CAPABILITY_WIN_LIC_PASSTHROUGH":          12,
		"API_CAPABILITY_VOLUME_SNAPSHOTS_IMMEDIATE":   13,
		"API_CAPABILITY_ENCRYPTED_PATCH_ENVELOPE":     14,
		"API_CAPABILITY_SINGLE_STACK_IP_NETWORK":      15,
		"API_CAPABILITY_CELLULAR_ATTACH_CONFIG":       16,
		"API_CAPABILITY_EDGEVIEW_AUTHENTICATION":      17,
		"API_CAPABILITY_DISABLE_VTPM":                 18,
		"API_CAPABILITY_LOC_REBOOT_COLLECT_INFO":      19,
		"API_CAPABILITY_SMART_REPORT":                 20,
		"API_CAPABILITY_REPORT_TPM_EVENTLOG":          21,
	}
)
...
const (
	...
	MaintenanceModeReason_MAINTENANCE_MODE_REASON_TPM_ENCRYPTION_FAILURE  MaintenanceModeReason = 4
	MaintenanceModeReason_MAINTENANCE_MODE_REASON_TPM_QUOTE_FAILURE       MaintenanceModeReason = 5
	MaintenanceModeReason_MAINTENANCE_MODE_REASON_EDGE_NODE_CERTS_REFUSED MaintenanceModeReason = 6
)
...
var (
	MaintenanceModeReason_name = map[int32]string{
		...
		4: "MAINTENANCE_MODE_REASON_TPM_ENCRYPTION_FAILURE",
		5: "MAINTENANCE_MODE_REASON_TPM_QUOTE_FAILURE",
		6: "MAINTENANCE_MODE_REASON_EDGE_NODE_CERTS_REFUSED",
	}
...
const (
	...
	SnapshotType_SNAPSHOT_TYPE_IMMEDIATE   SnapshotType = 2 // Snapshot created as a result of an immediate snapshot
)
...
type SmartAttr struct {
	...
	Type          string `protobuf:"bytes,7,opt,name=type,proto3" json:"type,omitempty"`                                        // Informs the condition of the device e.g., pre-fail, old_age, etc.
	AttributeName string `protobuf:"bytes,8,opt,name=attribute_name,json=attributeName,proto3" json:"attribute_name,omitempty"` // the attribute name
}
...
type StorageDiskInfo struct {
	...
	SmartAttr       []*SmartAttr `protobuf:"bytes,8,rep,name=smart_attr,json=smartAttr,proto3" json:"smart_attr,omitempty"`                   // smartctl output
}
...
type CellularBearer struct {
	...
	BearerType evecommon.BearerType `protobuf:"varint,2,opt,name=bearer_type,json=bearerType,proto3,enum=org.lfedge.eve.common.BearerType" json:"bearer_type,omitempty"`
	...
	// disconnection).
	ConnectionError string `protobuf:"bytes,5,opt,name=connection_error,json=connectionError,proto3" json:"connection_error,omitempty"`
...
type CellularProfile struct {
	...
	BearerType evecommon.BearerType `protobuf:"varint,3,opt,name=bearer_type,json=bearerType,proto3,enum=org.lfedge.eve.common.BearerType" json:"bearer_type,omitempty"`
	// The IP addressing type used by the profile.
	IpType evecommon.CellularIPType `protobuf:"varint,4,opt,name=ip_type,json=ipType,proto3,enum=org.lfedge.eve.common.CellularIPType" json:"ip_type,omitempty"`
	// When true, the modem will not connect to networks that require roaming when using this profile.
	ForbidRoaming bool `protobuf:"varint,5,opt,name=forbid_roaming,json=forbidRoaming,proto3" json:"forbid_roaming,omitempty"`
}
...
type StorageDiskState struct {
	...
	SmartStatus string                     `protobuf:"bytes,4,opt,name=smart_status,json=smartStatus,proto3" json:"smart_status,omitempty"`            // S.M.A.R.T. info availability
}
...
type ZInfoDevice struct {
	...
	DeviceName     string `protobuf:"bytes,54,opt,name=device_name,json=deviceName,proto3" json:"device_name,omitempty"`
	EnterpriseName string `protobuf:"bytes,55,opt,name=enterprise_name,json=enterpriseName,proto3" json:"enterprise_name,omitempty"`
	EnterpriseId   string `protobuf:"bytes,56,opt,name=enterprise_id,json=enterpriseId,proto3" json:"enterprise_id,omitempty"`
	ProjectName    string `protobuf:"bytes,57,opt,name=project_name,json=projectName,proto3" json:"project_name,omitempty"`
	ProjectId      string `protobuf:"bytes,58,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`
	...
	EnrolledCerts []*CertInfo `protobuf:"bytes,60,rep,name=enrolled_certs,json=enrolledCerts,proto3" json:"enrolled_certs,omitempty"`
}
...
func (x *ZInfoDevice) GetDeviceName() string {
	if x != nil {
		return x.DeviceName
	}
	return ""
...
func (x *ZInfoDevice) GetEnterpriseName() string {
	if x != nil {
...
func (x *ZInfoDevice) GetEnterpriseId() string {
	if x != nil {
...
func (x *ZInfoDevice) GetProjectName() string {
	if x != nil {
...
func (x *ZInfoDevice) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *ZInfoDevice) GetEnrolledCerts() []*CertInfo {
	if x != nil {
		return x.EnrolledCerts
	}
	return nil
}
...
func (x *OptionalCapabilities) GetHwInventorySupport() bool {
	if x != nil {
		return x.HwInventorySupport
	}
	return false
}
...
type DevicePort struct {
	...
	MoreNtpServers []string `protobuf:"bytes,35,rep,name=more_ntp_servers,json=moreNtpServers,proto3" json:"more_ntp_servers,omitempty"`
	...
	ConfigSource *evecommon.PortConfigSource `protobuf:"bytes,40,opt,name=config_source,json=configSource,proto3" json:"config_source,omitempty"`
	// Device-reported 802.1X (PNAC) runtime status for this port.
	PnacStatus *PNACStatus `protobuf:"bytes,50,opt,name=pnac_status,json=pnacStatus,proto3" json:"pnac_status,omitempty"`
}
...
func (x *DevicePort) GetConfigSource() *evecommon.PortConfigSource {
	if x != nil {
...
func (x *DevicePort) GetPnacStatus() *PNACStatus {
	if x != nil {
		return x.PnacStatus
	}
	return nil
...
type ZCellularStatus struct {
	...
	Bearers []*CellularBearer `protobuf:"bytes,12,rep,name=bearers,proto3" json:"bearers,omitempty"`
	// Cellular connection profiles stored on the modem.
	Profiles []*CellularProfile `protobuf:"bytes,13,rep,name=profiles,proto3" json:"profiles,omitempty"`
}
...
type ZInfoMsg struct {
	...
	//	*ZInfoMsg_NtpSources
	//	*ZInfoMsg_ClusterInfo
	//	*ZInfoMsg_ClusterUpdateInfo
...
func (x *ZInfoMsg) GetClusterInfo() *ZInfoKubeCluster {
	if x, ok := x.GetInfoContent().(*ZInfoMsg_ClusterInfo); ok {
...
func (x *ZInfoMsg) GetClusterUpdateInfo() *ZInfoKubeClusterUpdateStatus {
	if x, ok := x.GetInfoContent().(*ZInfoMsg_ClusterUpdateInfo); ok {
...
func (*ZInfoMsg_ClusterInfo) isZInfoMsg_InfoContent() {}
...
type ZInfoKubeClusterUpdateStatus struct {
	...
	Component KubeComp `protobuf:"varint,2,opt,name=component,proto3,enum=org.lfedge.eve.info.KubeComp" json:"component,omitempty"`
	// status of the current component under update, KUBE_COMP_UPDATE_STATUS_UNSPECIFIED when
	//
	//	no updates in progress
	Status KubeCompUpdateStatus `protobuf:"varint,3,opt,name=status,proto3,enum=org.lfedge.eve.info.KubeCompUpdateStatus" json:"status,omitempty"`
...
func (x *ZInfoKubeClusterUpdateStatus) GetComponent() KubeComp {
	...
	return KubeComp_KUBE_COMP_UNSPECIFIED
}
...
func (x *ZInfoKubeClusterUpdateStatus) GetStatus() KubeCompUpdateStatus {
	...
	return KubeCompUpdateStatus_KUBE_COMP_UPDATE_STATUS_UNSPECIFIED
}
...
type ZInfoKubeCluster struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Info message on a list of cluster nodes
	Nodes []*KubeNodeInfo `protobuf:"bytes,1,rep,name=nodes,proto3" json:"nodes,omitempty"`
	// Info message on a list of namespaces's pods summary
	PodNameSpaces []*KubePodNameSpaceInfo `protobuf:"bytes,2,rep,name=pod_name_spaces,json=podNameSpaces,proto3" json:"pod_name_spaces,omitempty"`
	// Info message on a list of EVE applications
	EveApps []*KubeEVEAppPodInfo `protobuf:"bytes,3,rep,name=eve_apps,json=eveApps,proto3" json:"eve_apps,omitempty"`
	// Info message on cluster storage
	Storage *KubeStorageInfo `protobuf:"bytes,4,opt,name=storage,proto3" json:"storage,omitempty"`
	// Cluster UUID which will match config.EdgeNodeCluster.cluster_id passed
	//
	//	in to the node by the controller.
	ClusterId string `protobuf:"bytes,5,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`
	// Virtual Machines running on the cluster
	EveVmApps []*KubeVMIInfo `protobuf:"bytes,6,rep,name=eve_vm_apps,json=eveVmApps,proto3" json:"eve_vm_apps,omitempty"`
}
...
type ZInfoHardware struct {
	...
	EveRelease    string             `protobuf:"bytes,2,opt,name=eve_release,json=eveRelease,proto3" json:"eve_release,omitempty"`
	Inventory     *HardwareInventory `protobuf:"bytes,3,opt,name=inventory,proto3" json:"inventory,omitempty"`
	KernelFlavor  string             `protobuf:"bytes,4,opt,name=kernel_flavor,json=kernelFlavor,proto3" json:"kernel_flavor,omitempty"`    // e.g. "pc", "rt", "virt"
	KernelVersion string             `protobuf:"bytes,5,opt,name=kernel_version,json=kernelVersion,proto3" json:"kernel_version,omitempty"` // e.g. "6.6.45-eve"
	EvePlatform   string             `protobuf:"bytes,6,opt,name=eve_platform,json=evePlatform,proto3" json:"eve_platform,omitempty"`       // board/platform name
	Partition     string             `protobuf:"bytes,7,opt,name=partition,proto3" json:"partition,omitempty"`                              // e.g. "IMGA", "IMGB"
	KernelCmdline string             `protobuf:"bytes,8,opt,name=kernel_cmdline,json=kernelCmdline,proto3" json:"kernel_cmdline,omitempty"` // current kernel command line
}
...
func (x *ZInfoHardware) GetEveRelease() string {
	if x != nil {
		return x.EveRelease
	}
	return ""
...
func (x *ZInfoHardware) GetInventory() *HardwareInventory {
	if x != nil {
		return x.Inventory
	}
	return nil
...
func (x *ZInfoHardware) GetKernelFlavor() string {
	if x != nil {
		return x.KernelFlavor
	}
	return ""
}

func (x *ZInfoHardware) GetKernelVersion() string {
	if x != nil {
...
func (x *ZInfoHardware) GetEvePlatform() string {
	if x != nil {
		return x.EvePlatform
	}
	return ""
}

func (x *ZInfoHardware) GetPartition() string {
	if x != nil {
		return x.Partition
	}
	return ""
...
func (x *ZInfoHardware) GetKernelCmdline() string {
	if x != nil {
...
var file_info_info_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0x6c, 0x0a, 0x0b, 0x49, 0x6f, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x12,
	...
	,
	...
	,
	...
	,
	...
	0x44, 0x4e, 0x53, 0x52, 0x03, 0x64, 0x6e, 0x73, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x70, 0x76, 0x34,
	0x5f, 0x75, 0x70, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x69, 0x70, 0x76, 0x34, 0x55,
	...
	,
	...
	0x6b, 0x0a, 0x17, 0x55, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	,
	...
	,
	...
	,
	...
	0x49, 0x50, 0x54, 0x79, 0x70, 0x65, 0x52, 0x06, 0x69, 0x70, 0x54, 0x79, 0x70, 0x65, 0x12, 0x25,
	0x0a, 0x0e, 0x66, 0x6f, 0x72, 0x62, 0x69, 0x64, 0x5f, 0x72, 0x6f, 0x61, 0x6d, 0x69, 0x6e, 0x67,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x66, 0x6f, 0x72, 0x62, 0x69, 0x64, 0x52, 0x6f,
	0x61, 0x6d, 0x69, 0x6e, 0x67, 0x22, 0xcc, 0x01, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	...
	,
	...
	0x73, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x64, 0x69, 0x73, 0x6b, 0x73, 0x12, 0x40,
	0x0a, 0x08, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x72, 0x65, 0x6e, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x24, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67, 0x65, 0x2e, 0x65, 0x76,
	0x65, 0x2e, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x43, 0x68,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x66, 0x6f, 0x52, 0x07, 0x73, 0x6e, 0x61, 0x70, 0x45, 0x72, 0x72, 0x22, 0x60, 0x0a, 0x10, 0x5a,
	0x49, 0x6e, 0x66, 0x6f, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x4e, 0x6f, 0x64, 0x65, 0x12,
	0x4c, 0x0a, 0x0b, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x2b, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67,
	0x65, 0x2e, 0x65, 0x76, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x5a, 0x49, 0x6e, 0x66, 0x6f,
	0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x52, 0x0a, 0x6e, 0x6f, 0x64, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x86, 0x05,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0x36, 0x0a, 0x10, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x73, 0x12, 0x22, 0x0a, 0x0c, 0x63, 0x75, 0x72, 0x53, 0x69, 0x7a, 0x65, 0x42,
	0x79, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x63, 0x75, 0x72, 0x53,
	0x69, 0x7a, 0x65, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0xc9, 0x03, 0x0a, 0x10, 0x5a, 0x49, 0x6e,
	0x66, 0x6f, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x54, 0x72, 0x65, 0x65, 0x12, 0x12, 0x0a,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x68, 0x61, 0x32, 0x35, 0x36, 0x12, 0x43, 0x0a, 0x09, 0x72,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25,
	0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x2e,
	0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x73, 0x52, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73,
	0x12, 0x34, 0x0a, 0x05, 0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	,
	...
	0x61, 0x22, 0xe2, 0x01, 0x0a, 0x0d, 0x5a, 0x49, 0x6e, 0x66, 0x6f, 0x45, 0x64, 0x67, 0x65, 0x76,
	0x69, 0x65, 0x77, 0x12, 0x3b, 0x0a, 0x0b, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x5f, 0x74, 0x69,
	...
	0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x64, 0x65, 0x76, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x08, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x44, 0x65, 0x76, 0x12, 0x1b, 0x0a, 0x09,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x61, 0x70, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x08, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x41, 0x70, 0x70, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x5f, 0x65, 0x78, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x45, 0x78, 0x74, 0x22, 0xe8, 0x03, 0x0a, 0x0d, 0x5a, 0x49, 0x6e, 0x66, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_info_info_proto_goTypes = []interface{}{
	...
	(PCRStatus)(0),                       // 5: org.lfedge.eve.info.PCRStatus
	(SimType)(0),                         // 6: org.lfedge.eve.info.SimType
	(ZCellularOperatingState)(0),         // 7: org.lfedge.eve.info.ZCellularOperatingState
	(ZCellularControlProtocol)(0),        // 8: org.lfedge.eve.info.ZCellularControlProtocol
	(ZDeviceState)(0),                    // 9: org.lfedge.eve.info.ZDeviceState
	(StorageStatus)(0),                   // 10: org.lfedge.eve.info.StorageStatus
	(StorageRaidType)(0),                 // 11: org.lfedge.eve.info.StorageRaidType
	(StorageTypeInfo)(0),                 // 12: org.lfedge.eve.info.StorageTypeInfo
	(APICapability)(0),                   // 13: org.lfedge.eve.info.APICapability
	(BootReason)(0),                      // 14: org.lfedge.eve.info.BootReason
	(MaintenanceModeReason)(0),           // 15: org.lfedge.eve.info.MaintenanceModeReason
	(AttestationState)(0),                // 16: org.lfedge.eve.info.AttestationState
	(AppInstMetaDataType)(0),             // 17: org.lfedge.eve.info.AppInstMetaDataType
	(WirelessType)(0),                    // 18: org.lfedge.eve.info.WirelessType
	(BaseOsStatus)(0),                    // 19: org.lfedge.eve.info.BaseOsStatus
	(BaseOsSubStatus)(0),                 // 20: org.lfedge.eve.info.BaseOsSubStatus
	(SnapshotType)(0),                    // 21: org.lfedge.eve.info.SnapshotType
	(ZInfoClusterNodeStatus)(0),          // 22: org.lfedge.eve.info.ZInfoClusterNodeStatus
	...
	(*SmartAttr)(nil),                    // 26: org.lfedge.eve.info.SmartAttr
	(*StorageDiskInfo)(nil),              // 27: org.lfedge.eve.info.StorageDiskInfo
	...
	(*CellularBearer)(nil),               // 49: org.lfedge.eve.info.CellularBearer
	(*CellularProfile)(nil),              // 50: org.lfedge.eve.info.CellularProfile
	(*StorageDiskState)(nil),             // 51: org.lfedge.eve.info.StorageDiskState
	(*StorageChildren)(nil),              // 52: org.lfedge.eve.info.StorageChildren
	(*StorageInfo)(nil),                  // 53: org.lfedge.eve.info.StorageInfo
	(*ZInfoDevice)(nil),                  // 54: org.lfedge.eve.info.ZInfoDevice
	(*OptionalCapabilities)(nil),         // 55: org.lfedge.eve.info.OptionalCapabilities
	(*AttestationInfo)(nil),              // 56: org.lfedge.eve.info.AttestationInfo
	(*SystemAdapterInfo)(nil),            // 57: org.lfedge.eve.info.SystemAdapterInfo
	(*DevicePortStatus)(nil),             // 58: org.lfedge.eve.info.DevicePortStatus
	(*DevicePort)(nil),                   // 59: org.lfedge.eve.info.DevicePort
	(*ProxyStatus)(nil),                  // 60: org.lfedge.eve.info.ProxyStatus
	(*ProxyEntry)(nil),                   // 61: org.lfedge.eve.info.ProxyEntry
	(*WirelessStatus)(nil),               // 62: org.lfedge.eve.info.WirelessStatus
	(*ZCellularStatus)(nil),              // 63: org.lfedge.eve.info.ZCellularStatus
	(*ZInfoDevSW)(nil),                   // 64: org.lfedge.eve.info.ZInfoDevSW
	(*ZInfoStorage)(nil),                 // 65: org.lfedge.eve.info.ZInfoStorage
	(*ZInfoSnapshot)(nil),                // 66: org.lfedge.eve.info.ZInfoSnapshot
	(*ZInfoClusterNode)(nil),             // 67: org.lfedge.eve.info.ZInfoClusterNode
	...
	(*IPRoute)(nil),                      // 75: org.lfedge.eve.info.IPRoute
	(*UsageInfo)(nil),                    // 76: org.lfedge.eve.info.UsageInfo
	(*VolumeResources)(nil),              // 77: org.lfedge.eve.info.VolumeResources
	(*ZInfoVolume)(nil),                  // 78: org.lfedge.eve.info.ZInfoVolume
	(*ContentResources)(nil),             // 79: org.lfedge.eve.info.ContentResources
	(*ZInfoContentTree)(nil),             // 80: org.lfedge.eve.info.ZInfoContentTree
	(*ZInfoBlob)(nil),                    // 81: org.lfedge.eve.info.ZInfoBlob
	(*ZInfoBlobList)(nil),                // 82: org.lfedge.eve.info.ZInfoBlobList
	(*ZInfoMsg)(nil),                     // 83: org.lfedge.eve.info.ZInfoMsg
	(*Capabilities)(nil),                 // 84: org.lfedge.eve.info.Capabilities
	(*ZInfoAppInstMetaData)(nil),         // 85: org.lfedge.eve.info.ZInfoAppInstMetaData
	(*ZInfoEdgeview)(nil),                // 86: org.lfedge.eve.info.ZInfoEdgeview
	(*ZInfoLocation)(nil),                // 87: org.lfedge.eve.info.ZInfoLocation
	(*ZInfoKubeClusterUpdateStatus)(nil), // 88: org.lfedge.eve.info.ZInfoKubeClusterUpdateStatus
	(*ZInfoKubeCluster)(nil),             // 89: org.lfedge.eve.info.ZInfoKubeCluster
	(*ZInfoHardware)(nil),                // 90: org.lfedge.eve.info.ZInfoHardware
	nil,                                  // 91: org.lfedge.eve.info.ZInfoConfigItemStatus.ConfigItemsEntry
	nil,                                  // 92: org.lfedge.eve.info.ZInfoConfigItemStatus.UnknownConfigItemsEntry
	(evecommon.PhyIoType)(0),             // 93: org.lfedge.eve.common.PhyIoType
	(evecommon.PhyIoMemberUsage)(0),      // 94: org.lfedge.eve.common.PhyIoMemberUsage
	(*ErrorInfo)(nil),                    // 95: org.lfedge.eve.info.ErrorInfo
	(evecommon.BearerType)(0),            // 96: org.lfedge.eve.common.BearerType
	(evecommon.CellularIPType)(0),        // 97: org.lfedge.eve.common.CellularIPType
	(*timestamppb.Timestamp)(nil),        // 98: google.protobuf.Timestamp
	(*evecommon.DiskDescription)(nil),    // 99: org.lfedge.eve.common.DiskDescription
	(*CertInfo)(nil),                     // 100: org.lfedge.eve.info.CertInfo
	(*evecommon.PortConfigSource)(nil),   // 101: org.lfedge.eve.common.PortConfigSource
	(*PNACStatus)(nil),                   // 102: org.lfedge.eve.info.PNACStatus
	(evecommon.RadioAccessTechnology)(0), // 103: org.lfedge.eve.common.RadioAccessTechnology
	(*ZInfoPatchEnvelope)(nil),           // 104: org.lfedge.eve.info.ZInfoPatchEnvelope
	(*ZInfoNTPSources)(nil),              // 105: org.lfedge.eve.info.ZInfoNTPSources
	(KubeComp)(0),                        // 106: org.lfedge.eve.info.KubeComp
	(KubeCompUpdateStatus)(0),            // 107: org.lfedge.eve.info.KubeCompUpdateStatus
	(*KubeNodeInfo)(nil),                 // 108: org.lfedge.eve.info.KubeNodeInfo
	(*KubePodNameSpaceInfo)(nil),         // 109: org.lfedge.eve.info.KubePodNameSpaceInfo
	(*KubeEVEAppPodInfo)(nil),            // 110: org.lfedge.eve.info.KubeEVEAppPodInfo
	(*KubeStorageInfo)(nil),              // 111: org.lfedge.eve.info.KubeStorageInfo
	(*KubeVMIInfo)(nil),                  // 112: org.lfedge.eve.info.KubeVMIInfo
	(*HardwareInventory)(nil),            // 113: org.lfedge.eve.info.HardwareInventory
}
var file_info_info_proto_depIdxs = []int32{
	26,  // 0: org.lfedge.eve.info.StorageDiskInfo.smart_attr:type_name -> org.lfedge.eve.info.SmartAttr
	0,   // 1: org.lfedge.eve.info.deprecatedMetricItem.type:type_name -> org.lfedge.eve.info.DepMetricItemType
	93,  // 2: org.lfedge.eve.info.ZioBundle.type:type_name -> org.lfedge.eve.common.PhyIoType
	32,  // 3: org.lfedge.eve.info.ZioBundle.ioAddressList:type_name -> org.lfedge.eve.info.IoAddresses
	94,  // 4: org.lfedge.eve.info.ZioBundle.usage:type_name -> org.lfedge.eve.common.PhyIoMemberUsage
	95,  // 5: org.lfedge.eve.info.ZioBundle.err:type_name -> org.lfedge.eve.info.ErrorInfo
	33,  // 6: org.lfedge.eve.info.IoAddresses.vf_info:type_name -> org.lfedge.eve.info.VfPublishedInfo
	37,  // 7: org.lfedge.eve.info.ZInfoNetwork.dns:type_name -> org.lfedge.eve.info.ZInfoDNS
	36,  // 8: org.lfedge.eve.info.ZInfoNetwork.location:type_name -> org.lfedge.eve.info.GeoLoc
	95,  // 9: org.lfedge.eve.info.ZInfoNetwork.networkErr:type_name -> org.lfedge.eve.info.ErrorInfo
	60,  // 10: org.lfedge.eve.info.ZInfoNetwork.proxy:type_name -> org.lfedge.eve.info.ProxyStatus
	...
	95,  // 13: org.lfedge.eve.info.VaultInfo.vaultErr:type_name -> org.lfedge.eve.info.ErrorInfo
	5,   // 14: org.lfedge.eve.info.VaultInfo.pcrStatus:type_name -> org.lfedge.eve.info.PCRStatus
	4,   // 15: org.lfedge.eve.info.DataSecAtRest.status:type_name -> org.lfedge.eve.info.DataSecAtRestStatus
	39,  // 16: org.lfedge.eve.info.DataSecAtRest.vaultList:type_name -> org.lfedge.eve.info.VaultInfo
	91,  // 17: org.lfedge.eve.info.ZInfoConfigItemStatus.configItems:type_name -> org.lfedge.eve.info.ZInfoConfigItemStatus.ConfigItemsEntry
	92,  // 18: org.lfedge.eve.info.ZInfoConfigItemStatus.unknownConfigItems:type_name -> org.lfedge.eve.info.ZInfoConfigItemStatus.UnknownConfigItemsEntry
	6,   // 19: org.lfedge.eve.info.ZSimcardInfo.type:type_name -> org.lfedge.eve.info.SimType
	7,   // 20: org.lfedge.eve.info.ZCellularModuleInfo.operating_state:type_name -> org.lfedge.eve.info.ZCellularOperatingState
	8,   // 21: org.lfedge.eve.info.ZCellularModuleInfo.control_protocol:type_name -> org.lfedge.eve.info.ZCellularControlProtocol
	96,  // 22: org.lfedge.eve.info.CellularBearer.bearer_type:type_name -> org.lfedge.eve.common.BearerType
	97,  // 23: org.lfedge.eve.info.CellularBearer.ip_type:type_name -> org.lfedge.eve.common.CellularIPType
	98,  // 24: org.lfedge.eve.info.CellularBearer.connected_at:type_name -> google.protobuf.Timestamp
	96,  // 25: org.lfedge.eve.info.CellularProfile.bearer_type:type_name -> org.lfedge.eve.common.BearerType
	97,  // 26: org.lfedge.eve.info.CellularProfile.ip_type:type_name -> org.lfedge.eve.common.CellularIPType
	99,  // 27: org.lfedge.eve.info.StorageDiskState.disk_name:type_name -> org.lfedge.eve.common.DiskDescription
	10,  // 28: org.lfedge.eve.info.StorageDiskState.status:type_name -> org.lfedge.eve.info.StorageStatus
	11,  // 29: org.lfedge.eve.info.StorageChildren.current_raid:type_name -> org.lfedge.eve.info.StorageRaidType
	51,  // 30: org.lfedge.eve.info.StorageChildren.disks:type_name -> org.lfedge.eve.info.StorageDiskState
	52,  // 31: org.lfedge.eve.info.StorageChildren.children:type_name -> org.lfedge.eve.info.StorageChildren
	12,  // 32: org.lfedge.eve.info.StorageInfo.storage_type:type_name -> org.lfedge.eve.info.StorageTypeInfo
	11,  // 33: org.lfedge.eve.info.StorageInfo.current_raid:type_name -> org.lfedge.eve.info.StorageRaidType
	10,  // 34: org.lfedge.eve.info.StorageInfo.storage_state:type_name -> org.lfedge.eve.info.StorageStatus
	51,  // 35: org.lfedge.eve.info.StorageInfo.disks:type_name -> org.lfedge.eve.info.StorageDiskState
	52,  // 36: org.lfedge.eve.info.StorageInfo.children:type_name -> org.lfedge.eve.info.StorageChildren
	34,  // 37: org.lfedge.eve.info.ZInfoDevice.minfo:type_name -> org.lfedge.eve.info.ZInfoManufacturer
	35,  // 38: org.lfedge.eve.info.ZInfoDevice.network:type_name -> org.lfedge.eve.info.ZInfoNetwork
	31,  // 39: org.lfedge.eve.info.ZInfoDevice.assignableAdapters:type_name -> org.lfedge.eve.info.ZioBundle
	37,  // 40: org.lfedge.eve.info.ZInfoDevice.dns:type_name -> org.lfedge.eve.info.ZInfoDNS
	65,  // 41: org.lfedge.eve.info.ZInfoDevice.storageList:type_name -> org.lfedge.eve.info.ZInfoStorage
	98,  // 42: org.lfedge.eve.info.ZInfoDevice.bootTime:type_name -> google.protobuf.Timestamp
	64,  // 43: org.lfedge.eve.info.ZInfoDevice.swList:type_name -> org.lfedge.eve.info.ZInfoDevSW
	28,  // 44: org.lfedge.eve.info.ZInfoDevice.metricItems:type_name -> org.lfedge.eve.info.deprecatedMetricItem
	98,  // 45: org.lfedge.eve.info.ZInfoDevice.lastRebootTime:type_name -> google.protobuf.Timestamp
	57,  // 46: org.lfedge.eve.info.ZInfoDevice.systemAdapter:type_name -> org.lfedge.eve.info.SystemAdapterInfo
	3,   // 47: org.lfedge.eve.info.ZInfoDevice.HSMStatus:type_name -> org.lfedge.eve.info.HwSecurityModuleStatus
	40,  // 48: org.lfedge.eve.info.ZInfoDevice.dataSecAtRestInfo:type_name -> org.lfedge.eve.info.DataSecAtRest
	41,  // 49: org.lfedge.eve.info.ZInfoDevice.sec_info:type_name -> org.lfedge.eve.info.SecurityInfo
	43,  // 50: org.lfedge.eve.info.ZInfoDevice.configItemStatus:type_name -> org.lfedge.eve.info.ZInfoConfigItemStatus
	44,  // 51: org.lfedge.eve.info.ZInfoDevice.appInstances:type_name -> org.lfedge.eve.info.ZInfoAppInstance
	14,  // 52: org.lfedge.eve.info.ZInfoDevice.last_boot_reason:type_name -> org.lfedge.eve.info.BootReason
	47,  // 53: org.lfedge.eve.info.ZInfoDevice.cell_radios:type_name -> org.lfedge.eve.info.ZCellularModuleInfo
	46,  // 54: org.lfedge.eve.info.ZInfoDevice.sims:type_name -> org.lfedge.eve.info.ZSimcardInfo
	45,  // 55: org.lfedge.eve.info.ZInfoDevice.tasks:type_name -> org.lfedge.eve.info.ZInfoDeviceTasks
	15,  // 56: org.lfedge.eve.info.ZInfoDevice.maintenance_mode_reason:type_name -> org.lfedge.eve.info.MaintenanceModeReason
	84,  // 57: org.lfedge.eve.info.ZInfoDevice.capabilities:type_name -> org.lfedge.eve.info.Capabilities
	9,   // 58: org.lfedge.eve.info.ZInfoDevice.state:type_name -> org.lfedge.eve.info.ZDeviceState
	15,  // 59: org.lfedge.eve.info.ZInfoDevice.maintenance_mode_reasons:type_name -> org.lfedge.eve.info.MaintenanceModeReason
	53,  // 60: org.lfedge.eve.info.ZInfoDevice.storage_info:type_name -> org.lfedge.eve.info.StorageInfo
	56,  // 61: org.lfedge.eve.info.ZInfoDevice.attestation_info:type_name -> org.lfedge.eve.info.AttestationInfo
	13,  // 62: org.lfedge.eve.info.ZInfoDevice.api_capability:type_name -> org.lfedge.eve.info.APICapability
	55,  // 63: org.lfedge.eve.info.ZInfoDevice.optional_capabilities:type_name -> org.lfedge.eve.info.OptionalCapabilities
	100, // 64: org.lfedge.eve.info.ZInfoDevice.enrolled_certs:type_name -> org.lfedge.eve.info.CertInfo
	16,  // 65: org.lfedge.eve.info.AttestationInfo.state:type_name -> org.lfedge.eve.info.AttestationState
	95,  // 66: org.lfedge.eve.info.AttestationInfo.error:type_name -> org.lfedge.eve.info.ErrorInfo
	58,  // 67: org.lfedge.eve.info.SystemAdapterInfo.status:type_name -> org.lfedge.eve.info.DevicePortStatus
	98,  // 68: org.lfedge.eve.info.DevicePortStatus.timePriority:type_name -> google.protobuf.Timestamp
	98,  // 69: org.lfedge.eve.info.DevicePortStatus.lastFailed:type_name -> google.protobuf.Timestamp
	98,  // 70: org.lfedge.eve.info.DevicePortStatus.lastSucceeded:type_name -> google.protobuf.Timestamp
	59,  // 71: org.lfedge.eve.info.DevicePortStatus.ports:type_name -> org.lfedge.eve.info.DevicePort
	60,  // 72: org.lfedge.eve.info.DevicePort.proxy:type_name -> org.lfedge.eve.info.ProxyStatus
	37,  // 73: org.lfedge.eve.info.DevicePort.dns:type_name -> org.lfedge.eve.info.ZInfoDNS
	36,  // 74: org.lfedge.eve.info.DevicePort.location:type_name -> org.lfedge.eve.info.GeoLoc
	95,  // 75: org.lfedge.eve.info.DevicePort.err:type_name -> org.lfedge.eve.info.ErrorInfo
	94,  // 76: org.lfedge.eve.info.DevicePort.usage:type_name -> org.lfedge.eve.common.PhyIoMemberUsage
	62,  // 77: org.lfedge.eve.info.DevicePort.wireless_status:type_name -> org.lfedge.eve.info.WirelessStatus
	101, // 78: org.lfedge.eve.info.DevicePort.config_source:type_name -> org.lfedge.eve.common.PortConfigSource
	102, // 79: org.lfedge.eve.info.DevicePort.pnac_status:type_name -> org.lfedge.eve.info.PNACStatus
	61,  // 80: org.lfedge.eve.info.ProxyStatus.proxies:type_name -> org.lfedge.eve.info.ProxyEntry
	18,  // 81: org.lfedge.eve.info.WirelessStatus.type:type_name -> org.lfedge.eve.info.WirelessType
	63,  // 82: org.lfedge.eve.info.WirelessStatus.cellular:type_name -> org.lfedge.eve.info.ZCellularStatus
	48,  // 83: org.lfedge.eve.info.ZCellularStatus.providers:type_name -> org.lfedge.eve.info.ZCellularProvider
	103, // 84: org.lfedge.eve.info.ZCellularStatus.current_rats:type_name -> org.lfedge.eve.common.RadioAccessTechnology
	98,  // 85: org.lfedge.eve.info.ZCellularStatus.connected_at:type_name -> google.protobuf.Timestamp
	49,  // 86: org.lfedge.eve.info.ZCellularStatus.bearers:type_name -> org.lfedge.eve.info.CellularBearer
	50,  // 87: org.lfedge.eve.info.ZCellularStatus.profiles:type_name -> org.lfedge.eve.info.CellularProfile
	2,   // 88: org.lfedge.eve.info.ZInfoDevSW.status:type_name -> org.lfedge.eve.info.ZSwState
	95,  // 89: org.lfedge.eve.info.ZInfoDevSW.swErr:type_name -> org.lfedge.eve.info.ErrorInfo
	19,  // 90: org.lfedge.eve.info.ZInfoDevSW.userStatus:type_name -> org.lfedge.eve.info.BaseOsStatus
	20,  // 91: org.lfedge.eve.info.ZInfoDevSW.subStatus:type_name -> org.lfedge.eve.info.BaseOsSubStatus
	98,  // 92: org.lfedge.eve.info.ZInfoSnapshot.create_time:type_name -> google.protobuf.Timestamp
	21,  // 93: org.lfedge.eve.info.ZInfoSnapshot.type:type_name -> org.lfedge.eve.info.SnapshotType
	95,  // 94: org.lfedge.eve.info.ZInfoSnapshot.snap_err:type_name -> org.lfedge.eve.info.ErrorInfo
	22,  // 95: org.lfedge.eve.info.ZInfoClusterNode.node_status:type_name -> org.lfedge.eve.info.ZInfoClusterNodeStatus
	38,  // 96: org.lfedge.eve.info.ZInfoApp.softwareList:type_name -> org.lfedge.eve.info.ZInfoSW
	98,  // 97: org.lfedge.eve.info.ZInfoApp.bootTime:type_name -> google.protobuf.Timestamp
	31,  // 98: org.lfedge.eve.info.ZInfoApp.assignedAdapters:type_name -> org.lfedge.eve.info.ZioBundle
	95,  // 99: org.lfedge.eve.info.ZInfoApp.appErr:type_name -> org.lfedge.eve.info.ErrorInfo
	2,   // 100: org.lfedge.eve.info.ZInfoApp.state:type_name -> org.lfedge.eve.info.ZSwState
	35,  // 101: org.lfedge.eve.info.ZInfoApp.network:type_name -> org.lfedge.eve.info.ZInfoNetwork
	66,  // 102: org.lfedge.eve.info.ZInfoApp.snapshots:type_name -> org.lfedge.eve.info.ZInfoSnapshot
	23,  // 103: org.lfedge.eve.info.ZInfoVpnLink.state:type_name -> org.lfedge.eve.info.ZInfoVpnState
	69,  // 104: org.lfedge.eve.info.ZInfoVpnLink.lInfo:type_name -> org.lfedge.eve.info.ZInfoVpnLinkInfo
	69,  // 105: org.lfedge.eve.info.ZInfoVpnLink.rInfo:type_name -> org.lfedge.eve.info.ZInfoVpnLinkInfo
	23,  // 106: org.lfedge.eve.info.ZInfoVpnConn.state:type_name -> org.lfedge.eve.info.ZInfoVpnState
	71,  // 107: org.lfedge.eve.info.ZInfoVpnConn.lInfo:type_name -> org.lfedge.eve.info.ZInfoVpnEndPoint
	71,  // 108: org.lfedge.eve.info.ZInfoVpnConn.rInfo:type_name -> org.lfedge.eve.info.ZInfoVpnEndPoint
	70,  // 109: org.lfedge.eve.info.ZInfoVpnConn.links:type_name -> org.lfedge.eve.info.ZInfoVpnLink
	72,  // 110: org.lfedge.eve.info.ZInfoVpn.conn:type_name -> org.lfedge.eve.info.ZInfoVpnConn
	98,  // 111: org.lfedge.eve.info.ZInfoNetworkInstance.upTimeStamp:type_name -> google.protobuf.Timestamp
	38,  // 112: org.lfedge.eve.info.ZInfoNetworkInstance.softwareList:type_name -> org.lfedge.eve.info.ZInfoSW
	29,  // 113: org.lfedge.eve.info.ZInfoNetworkInstance.ipAssignments:type_name -> org.lfedge.eve.info.ZmetIPAssignmentEntry
	30,  // 114: org.lfedge.eve.info.ZInfoNetworkInstance.vifs:type_name -> org.lfedge.eve.info.ZmetVifInfo
	31,  // 115: org.lfedge.eve.info.ZInfoNetworkInstance.assignedAdapters:type_name -> org.lfedge.eve.info.ZioBundle
	73,  // 116: org.lfedge.eve.info.ZInfoNetworkInstance.vinfo:type_name -> org.lfedge.eve.info.ZInfoVpn
	95,  // 117: org.lfedge.eve.info.ZInfoNetworkInstance.networkErr:type_name -> org.lfedge.eve.info.ErrorInfo
	24,  // 118: org.lfedge.eve.info.ZInfoNetworkInstance.state:type_name -> org.lfedge.eve.info.ZNetworkInstanceState
	75,  // 119: org.lfedge.eve.info.ZInfoNetworkInstance.ip_routes:type_name -> org.lfedge.eve.info.IPRoute
	98,  // 120: org.lfedge.eve.info.UsageInfo.createTime:type_name -> google.protobuf.Timestamp
	98,  // 121: org.lfedge.eve.info.UsageInfo.lastRefcountChangeTime:type_name -> google.protobuf.Timestamp
	76,  // 122: org.lfedge.eve.info.ZInfoVolume.usage:type_name -> org.lfedge.eve.info.UsageInfo
	77,  // 123: org.lfedge.eve.info.ZInfoVolume.resources:type_name -> org.lfedge.eve.info.VolumeResources
	2,   // 124: org.lfedge.eve.info.ZInfoVolume.state:type_name -> org.lfedge.eve.info.ZSwState
	95,  // 125: org.lfedge.eve.info.ZInfoVolume.volumeErr:type_name -> org.lfedge.eve.info.ErrorInfo
	79,  // 126: org.lfedge.eve.info.ZInfoContentTree.resources:type_name -> org.lfedge.eve.info.ContentResources
	76,  // 127: org.lfedge.eve.info.ZInfoContentTree.usage:type_name -> org.lfedge.eve.info.UsageInfo
	2,   // 128: org.lfedge.eve.info.ZInfoContentTree.state:type_name -> org.lfedge.eve.info.ZSwState
	95,  // 129: org.lfedge.eve.info.ZInfoContentTree.err:type_name -> org.lfedge.eve.info.ErrorInfo
	79,  // 130: org.lfedge.eve.info.ZInfoBlob.resources:type_name -> org.lfedge.eve.info.ContentResources
	76,  // 131: org.lfedge.eve.info.ZInfoBlob.usage:type_name -> org.lfedge.eve.info.UsageInfo
	2,   // 132: org.lfedge.eve.info.ZInfoBlob.state:type_name -> org.lfedge.eve.info.ZSwState
	95,  // 133: org.lfedge.eve.info.ZInfoBlob.err:type_name -> org.lfedge.eve.info.ErrorInfo
	81,  // 134: org.lfedge.eve.info.ZInfoBlobList.blob:type_name -> org.lfedge.eve.info.ZInfoBlob
	1,   // 135: org.lfedge.eve.info.ZInfoMsg.ztype:type_name -> org.lfedge.eve.info.ZInfoTypes
	54,  // 136: org.lfedge.eve.info.ZInfoMsg.dinfo:type_name -> org.lfedge.eve.info.ZInfoDevice
	68,  // 137: org.lfedge.eve.info.ZInfoMsg.ainfo:type_name -> org.lfedge.eve.info.ZInfoApp
	74,  // 138: org.lfedge.eve.info.ZInfoMsg.niinfo:type_name -> org.lfedge.eve.info.ZInfoNetworkInstance
	78,  // 139: org.lfedge.eve.info.ZInfoMsg.vinfo:type_name -> org.lfedge.eve.info.ZInfoVolume
	80,  // 140: org.lfedge.eve.info.ZInfoMsg.cinfo:type_name -> org.lfedge.eve.info.ZInfoContentTree
	82,  // 141: org.lfedge.eve.info.ZInfoMsg.binfo:type_name -> org.lfedge.eve.info.ZInfoBlobList
	85,  // 142: org.lfedge.eve.info.ZInfoMsg.amdinfo:type_name -> org.lfedge.eve.info.ZInfoAppInstMetaData
	86,  // 143: org.lfedge.eve.info.ZInfoMsg.evinfo:type_name -> org.lfedge.eve.info.ZInfoEdgeview
	90,  // 144: org.lfedge.eve.info.ZInfoMsg.hwinfo:type_name -> org.lfedge.eve.info.ZInfoHardware
	87,  // 145: org.lfedge.eve.info.ZInfoMsg.locinfo:type_name -> org.lfedge.eve.info.ZInfoLocation
	104, // 146: org.lfedge.eve.info.ZInfoMsg.patchInfo:type_name -> org.lfedge.eve.info.ZInfoPatchEnvelope
	67,  // 147: org.lfedge.eve.info.ZInfoMsg.cluster_node:type_name -> org.lfedge.eve.info.ZInfoClusterNode
	105, // 148: org.lfedge.eve.info.ZInfoMsg.ntp_sources:type_name -> org.lfedge.eve.info.ZInfoNTPSources
	89,  // 149: org.lfedge.eve.info.ZInfoMsg.cluster_info:type_name -> org.lfedge.eve.info.ZInfoKubeCluster
	88,  // 150: org.lfedge.eve.info.ZInfoMsg.cluster_update_info:type_name -> org.lfedge.eve.info.ZInfoKubeClusterUpdateStatus
	98,  // 151: org.lfedge.eve.info.ZInfoMsg.atTimeStamp:type_name -> google.protobuf.Timestamp
	17,  // 152: org.lfedge.eve.info.ZInfoAppInstMetaData.type:type_name -> org.lfedge.eve.info.AppInstMetaDataType
	98,  // 153: org.lfedge.eve.info.ZInfoEdgeview.expire_time:type_name -> google.protobuf.Timestamp
	98,  // 154: org.lfedge.eve.info.ZInfoEdgeview.started_time:type_name -> google.protobuf.Timestamp
	98,  // 155: org.lfedge.eve.info.ZInfoLocation.utc_timestamp:type_name -> google.protobuf.Timestamp
	25,  // 156: org.lfedge.eve.info.ZInfoLocation.horizontal_reliability:type_name -> org.lfedge.eve.info.LocReliability
	25,  // 157: org.lfedge.eve.info.ZInfoLocation.vertical_reliability:type_name -> org.lfedge.eve.info.LocReliability
	106, // 158: org.lfedge.eve.info.ZInfoKubeClusterUpdateStatus.component:type_name -> org.lfedge.eve.info.KubeComp
	107, // 159: org.lfedge.eve.info.ZInfoKubeClusterUpdateStatus.status:type_name -> org.lfedge.eve.info.KubeCompUpdateStatus
	95,  // 160: org.lfedge.eve.info.ZInfoKubeClusterUpdateStatus.error:type_name -> org.lfedge.eve.info.ErrorInfo
	108, // 161: org.lfedge.eve.info.ZInfoKubeCluster.nodes:type_name -> org.lfedge.eve.info.KubeNodeInfo
	109, // 162: org.lfedge.eve.info.ZInfoKubeCluster.pod_name_spaces:type_name -> org.lfedge.eve.info.KubePodNameSpaceInfo
	110, // 163: org.lfedge.eve.info.ZInfoKubeCluster.eve_apps:type_name -> org.lfedge.eve.info.KubeEVEAppPodInfo
	111, // 164: org.lfedge.eve.info.ZInfoKubeCluster.storage:type_name -> org.lfedge.eve.info.KubeStorageInfo
	112, // 165: org.lfedge.eve.info.ZInfoKubeCluster.eve_vm_apps:type_name -> org.lfedge.eve.info.KubeVMIInfo
	27,  // 166: org.lfedge.eve.info.ZInfoHardware.disks:type_name -> org.lfedge.eve.info.StorageDiskInfo
	113, // 167: org.lfedge.eve.info.ZInfoHardware.inventory:type_name -> org.lfedge.eve.info.HardwareInventory
	42,  // 168: org.lfedge.eve.info.ZInfoConfigItemStatus.ConfigItemsEntry.value:type_name -> org.lfedge.eve.info.ZInfoConfigItem
	42,  // 169: org.lfedge.eve.info.ZInfoConfigItemStatus.UnknownConfigItemsEntry.value:type_name -> org.lfedge.eve.info.ZInfoConfigItem
...
func file_info_info_proto_init() {
	...
	file_info_edge_node_cluster_proto_init()
	file_info_hardware_proto_init()
	file_info_pnac_proto_init()
	file_info_cert_proto_init()
	...
	file_info_info_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	file_info_info_proto_msgTypes[57].OneofWrappers = []interface{}{
		...
		(*ZInfoMsg_ClusterInfo)(nil),
		(*ZInfoMsg_ClusterUpdateInfo)(nil),
	}
	type x struct{}
